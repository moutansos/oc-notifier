...
#
# Defaults to http://127.0.0.1:4100; override with OC_NOTIFIER_URL / OC_NOTIFIER_TOKEN.
set -euo pipefail

BASE_URL="${OC_NOTIFIER_URL:-${CLAUDE_PLUGIN_OPTION_NOTIFIER_URL:-http://127.0.0.1:4100}}"
BASE_URL="${BASE_URL%/}"
